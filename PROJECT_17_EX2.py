...
# ___________________________________________________ Combine rowplus with rowminute  ___________________________________________________
...
cv2.imshow('Anh muc xam OpenCV',Gray_Image)
cv2.imshow('Transformed1',haar_wavelet(gray_array)[0])
cv2.imshow('Transformed2',haar_wavelet(gray_array)[1])
